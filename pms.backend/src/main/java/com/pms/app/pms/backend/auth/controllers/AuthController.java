...
import com.pms.app.pms.backend.auth.payload.*;
import com.pms.app.pms.backend.auth.repositories.RefreshTokenRepository;
import com.pms.app.pms.backend.auth.repositories.UserRepository;
import com.pms.app.pms.backend.auth.services.AuthService;
import com.pms.app.pms.backend.auth.services.impl.CookieService;
...
public class AuthController {
    ...
    @PostMapping("/refresh")
    @Transactional // Keeps Hibernate session open so lazy-loaded User roles are initialized properly
    public ResponseEntity<TokenResponse> refreshToken(
        ...
        // Fetch user directly from UserRepository to ensure an active, fully mapped entity state
